  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      ...
      <div className="mx-auto max-w-lg px-4 py-8">
        ...
        {step === "barber" && (<><button onClick={() => setStep("service")} className="mt-6 text-sm font-medium text-slate-500">← Back</button><h2 className="mt-2 mb-1 text-lg font-semibold">Pick your barber</h2>{staff.length === 0 ? <p className="mt-3 rounded-xl bg-white p-4 text-slate-500 ring-1 ring-slate-200">This shop hasn't added barbers yet.</p> : <div className="space-y-3">{staff.map((b) => {
