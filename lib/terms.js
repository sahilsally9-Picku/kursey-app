...
// Which optional service features each business type sees in Settings.
const FEATURE_MAP = {
  hair_salon:       { processing: true,  classes: false },
  spa:              { processing: true,  classes: false },
  skincare:         { processing: true,  classes: false },
  tanning:          { processing: true,  classes: false },
  waxing:           { processing: true,  classes: false },
  personal_trainer: { processing: false, classes: true },
  tutor:            { processing: false, classes: true },
};

export function features(businessType) {
  return FEATURE_MAP[businessType] || { processing: false, classes: false };
}